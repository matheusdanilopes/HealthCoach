  ...
  return (
    <div className="bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800/80 rounded-3xl overflow-hidden shadow-[0_1px_3px_0_rgb(0,0,0,0.04)] dark:shadow-none">
      <button
        ...
        className="w-full flex items-center gap-3 px-8 py-5 hover:bg-zinc-50/80 dark:hover:bg-zinc-800/20 transition-colors"
      >
      ...
      {expanded && (
        <div className="border-t border-zinc-100 dark:border-zinc-800/60">
          {logs.length === 0 ? (
            <p className="text-[12px] text-zinc-400 dark:text-zinc-500 text-center py-5">
            ...
            <ul>
              {logs.map((log) => (
                <li
                  key={log.id}
                  className="flex items-center gap-3 px-8 py-4 border-b border-zinc-50 dark:border-zinc-800/40 last:border-0"
                >
          ...
          <button
            onClick={onAdd}
            className="w-full flex items-center gap-2 px-8 py-4 text-[13px] text-blue-600 dark:text-blue-400 hover:bg-blue-50/50 dark:hover:bg-blue-950/20 transition-colors font-medium"
          >
